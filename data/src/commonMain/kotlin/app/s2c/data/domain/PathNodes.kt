...
package app.s2c.data.domain

import app.s2c.data.domain.PathNodes.ArcTo
import app.s2c.data.domain.PathNodes.CurveTo
import app.s2c.data.domain.PathNodes.HorizontalLineTo
import app.s2c.data.domain.PathNodes.LineTo
import app.s2c.data.domain.PathNodes.MoveTo
import app.s2c.data.domain.PathNodes.QuadTo
import app.s2c.data.domain.PathNodes.ReflectiveCurveTo
import app.s2c.data.domain.PathNodes.ReflectiveQuadTo
import app.s2c.data.domain.PathNodes.VerticalLineTo
...
import app.s2c.data.parser.method.MethodSizeAccountable.Companion.BOOLEAN_APPROXIMATE_BYTE_SIZE
