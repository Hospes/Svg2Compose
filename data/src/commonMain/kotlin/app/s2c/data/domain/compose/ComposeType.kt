package app.s2c.data.domain.compose

import app.s2c.data.domain.compose.PathFillType.Companion.EvenOdd
import app.s2c.data.domain.compose.PathFillType.Companion.NonZero
import app.s2c.data.domain.compose.StrokeCap.Companion.Butt
import app.s2c.data.domain.compose.StrokeCap.Companion.Round
import app.s2c.data.domain.compose.StrokeCap.Companion.Square
import app.s2c.data.domain.compose.StrokeJoin.Companion.Bevel
import app.s2c.data.domain.compose.StrokeJoin.Companion.Miter
import app.s2c.data.domain.compose.StrokeJoin.Companion.Round
